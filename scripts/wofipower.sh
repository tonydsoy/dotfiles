...
COMMANDS=('loginctl lock-session' 'command -v hyprshutdown >/dev/null 2>&1 && hyprshutdown || hyprctl dispatch "hl.dsp.exit()"' 'systemctl poweroff' 'systemctl reboot' 'systemctl suspend')
ICON_PATHS=(
